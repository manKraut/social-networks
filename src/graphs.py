...
class GraphAtts:
    ...
    def adjacency_matrix(self):
        ...
        # All values from head file will be retrieved and take only nodes, in order to construct the directed Graph
        for j in self.T.values():
            ...
            # move file to the relevant directory
            ...
            # save figure of the Graph into the same directory
            nx.draw(g)
...
class GraphToCsv:
    ...
    def centralities_to_csv(self):
        ...
        # store each centrality result into .csv file for further anipulation
